...
def refresh_textures(paths, exec_mode, paths_from_params):
    ...
    params_with_exec_mode = db_scan.encode_string(f'?{query_string};mode={exec_mode}', safe_chars='()!')
    execute_addon_with_builtin("script.file.viewer", params_with_exec_mode)
    execute_addon_with_builtin("script.music.art.preloader", params_with_exec_mode)
